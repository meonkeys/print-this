class ExtendedPDFConverter < (Asciidoctor::Converter.for 'pdf')
  ...
  # Loop over all pages.
  # Add something to empty pages, e.g. an invisible glyph (maybe just an ASCII 0x20 space character?).
  #
  # per Dan Allen:
  ...
  #
  # discussion at https://asciidoctor.zulipchat.com/#narrow/stream/288690-users.2Fasciidoctor-pdf/topic/syntax.20error.20with.20prepress.20PDF.20on.20Lulu
